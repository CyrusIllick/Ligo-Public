...
class TNCView:UIView{
    ...
    var termsLabelFont:UIFont = UIFont.systemFont(ofSize: 14)
  ...
  @objc fileprivate func onTap(){
   ...
   fileprivate func showError(vc:UIViewController){
    ...
    CustomAlert.error(presentFrom: vc, withTitle: errorAlertTitle, andMessage: errorAlertDesc)
